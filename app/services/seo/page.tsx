  ...
  const seoSteps = [
    {
      ...
      desc: "نبدأ بفحص شامل لـ Core Web Vitals، وإصلاح أخطاء الزحف، وبنية الأكواد، وسرعة الموقع لضشان توافقه الكامل مع عناكب بحث جوجل.",
          ...
          <div className="max-w-4xl mx-auto px-6 relative z-10">
            <div className="text-center mb-12 space-y-4">
              ...
              <p className="text-slate-400 max-w-xl mx-auto text-sm md:text-base font-medium leading-relaxed">
                املأ بياناتك بالأسفل، وسيقوم مهندسو الأرشفة لدينا بفحص موقعك وإرسال خطة تصدر شاملة إلى بريدك الإلكتروني.
              </p>
            </div>
            ...
            >
              {isSubmitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="space-y-2 text-right">
                      ...
                      <input 
                        ...
                        className="w-full bg-slate-950/80 border border-slate-800 focus:border-amber-500/60 text-white rounded-xl px-4 py-3 text-sm outline-none transition-colors"
                      />
                    </div>

                    {/* 2. مستطيل الهاتف */}
                    <div className="space-y-2 text-right">
                      <label className="text-xs font-bold text-slate-300 mr-2">رقم الهاتف (واتساب) :</label>
                      <input 
                        type="tel" 
                        name="phone" 
                        required 
                    ...
                    {/* 3. مستطيل الموقع الإلكتروني */}
                    <div className="space-y-2 text-right">
                      <label className="text-xs font-bold text-slate-300 mr-2">رابط موقعك (إن وجد) :</label>
                      <input 
                        type="url" 
                        name="website" 
                  ...
                  {/* 4. تفاصيل المشروع */}
                  <div className="space-y-2 text-right">
                    <label className="text-xs font-bold text-slate-300 mr-2">تفاصيل موقعك وتطلعاتك من السيو :</label>
                    <textarea 
                      name="message" 
                      rows={4}
                      required
                      placeholder="اكتب لنا لمحة عن خدمات شركتك والكلمات التي تود المنافسة عليها في محرك البحث..."
                      className="w-full bg-slate-950/80 border border-slate-800 focus:border-amber-500/60 text-white rounded-2xl px-4 py-3 text-sm outline-none transition-colors resize-none"
                    />
                  </div>
                  ...
                  <div className="pt-2">
                    <button 
                      ...
                      className="w-full bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white font-black py-4 rounded-xl text-lg transition-all duration-300 shadow-[0_4px_20px_rgba(245,158,11,0.2)] disabled:opacity-50 flex items-center justify-center gap-3 cursor-pointer"
                    >
                      {isSubmitting ? (
                        <>
                        ...
                        <>
                          <span>أرسل طلب الاستشارة الاستراتيجية مجاناً</span>
