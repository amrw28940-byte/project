    ...
    <section className="relative w-full h-[80vh] overflow-hidden">
      ...
      <div className="relative z-20 flex flex-col items-center justify-center h-full text-center px-4">
        ...
        <motion.a 
          ...
          whileTap={{ scale: 0.95 }}
          href="/calculate" 
          className="bg-yellow-500 text-black px-10 py-4 rounded-full font-black text-xl hover:bg-yellow-400 transition-all shadow-[0_0_20px_rgba(234,179,8,0.5)]"
        >
